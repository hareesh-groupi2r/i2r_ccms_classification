...
# ============================================================================
# Integrated Backend Startup Script for CCMS Classification System
# ============================================================================
# This script manages the startup of the integrated CCMS backend server
# Features:
...
BACKEND_DIR="$SCRIPT_DIR/integrated_backend"
...
start_server() {
    print_status "Starting integrated backend server..."
